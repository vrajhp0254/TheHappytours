...
const ContactForm = () => {
  return (
    <section>
      <div className="max-w-screen-xl mt-5  px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto  text-gray-900 ">
        ...
        <div className="">
          ...
          <div className="mt-8">
            <button className="uppercase text-sm font-bold tracking-wide rounded-tl-2xl rounded-br-2xl bg-[#1177FF]  text-white p-3 hover:rounded-2xl w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
